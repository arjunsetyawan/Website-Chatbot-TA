...
@section('page-title', 'Tambah Data Pasien Baru')
@section('page-sub', 'Daftarkan data pasien baru ke sistem')

@section('content')
    <div class="section-row">
        <div class="section-title">Form Tambah Data Pasien</div>
    ...
    <div class="card" style="max-width:700px;animation: fadeIn .35s ease both;">
        <div class="card-head">
            <div class="card-title"><span class="card-title-icon">➕</span> Data Pasien Baru</div>
        </div>
        <div style="padding:24px;">
            <form action="{{ route('admin.pasien.store') }}" method="POST">
                ...
                <div class="form-group" style="margin-bottom:18px;">
                    ...
                    <input type="text" name="no_rekam_medis" value="{{ old('no_rekam_medis') }}" required
                ...
                <div class="form-group" style="margin-bottom:24px;">
                    ...
                    <textarea name="keluhan_utama" rows="3"
                        ...
                        placeholder="Deskripsi keluhan utama pasien">{{ old('keluhan_utama') }}</textarea>
                </div>

                <!-- Actions -->
                <div style="display:flex;gap:10px;justify-content:flex-end;padding-top:16px;border-top:1px solid var(--border);">
                    <a href="{{ route('admin.pasien.index') }}" class="toolbar-btn" style="text-decoration:none;">Batal</a>
                    <button type="submit" class="toolbar-btn primary">💾 Simpan Data Pasien</button>
                </div>
            </form>
        </div>
    </div>
